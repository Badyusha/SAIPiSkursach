...
.then(username => {
    ...
    document.getElementById("name_account").addEventListener("change", function() {
        document.getElementById("name_account").style.border = 'none';
    });
...
function confirmTransfer() {
    $(document).ready(function() {
        ...
        let formData = {
            reciever_name: document.getElementById('name_account').value,
        ...
        $.ajax({
            type: 'POST',
            url: '/transferToBankClient', // URL адрес, на который отправляется запрос
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            data: { 
                ...
                commission_type: 'bank_client_transfer'
            },
            success: function(response) {
